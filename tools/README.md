...
| Subdir | What's in it |
|---|---|
| [`ingest/`](ingest/) | Get source docs from the Nextcloud archive into the corpus (Doxygen / Javadoc / SOA libs + WSDL → Markdown conversion, tag-driven copy, prune/reconcile, run the worker). |
